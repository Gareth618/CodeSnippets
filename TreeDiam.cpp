...
vector<int> getDiam(const vector<vector<int>>& ad) {
...
template<class T>
vector<pair<int, T>> getDiam(const vector<vector<pair<int, T>>>& ad) {
    ...
    vector<pair<int, T>> father(ad.size());
